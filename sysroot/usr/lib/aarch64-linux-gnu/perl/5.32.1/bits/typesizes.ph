...
unless(defined(&_BITS_TYPESIZES_H)) {
    ...
    eval 'sub __NLINK_T_TYPE () { &__U32_TYPE;}' unless defined(&__NLINK_T_TYPE);
    ...
    eval 'sub __BLKSIZE_T_TYPE () { &__S32_TYPE;}' unless defined(&__BLKSIZE_T_TYPE);
    ...
    eval 'sub __CPU_MASK_TYPE () { &__ULONGWORD_TYPE;}' unless defined(&__CPU_MASK_TYPE);
    if(defined(&__LP64__)) {
