...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 31 } }
...
unless (defined &__GNUC__) { sub __GNUC__() { 10 } }

unless (defined &__GNU_LIBRARY__) { sub __GNU_LIBRARY__() { 6 } }

unless (defined &__GXX_ABI_VERSION) { sub __GXX_ABI_VERSION() { 1014 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"10\.2\.1\\\ 20210110\"" } }
