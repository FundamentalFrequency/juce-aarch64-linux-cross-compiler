...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/aarch64-linux-gnu/perl/5.32',
    ...
    exe_ext => '',
    inc_version_list => '5.32.0 5.32.0/aarch64-linux-gnu-thread-multi',
    intsize => '4',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/aarch64-linux-gnu/perl/5.32.1',
