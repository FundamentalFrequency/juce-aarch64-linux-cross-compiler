...
get_filename_component(_realOrig "/usr/lib/llvm-11/lib/cmake/clang" REALPATH)
if(_realCurr STREQUAL _realOrig)
  set(_IMPORT_PREFIX "/usr/lib/llvm-11/lib/cmake/clang")
endif()
unset(_realOrig)
unset(_realCurr)
...
set_target_properties(clangTidyCERTModule PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangTidy;clangTidyBugproneModule;clangTidyGoogleModule;clangTidyMiscModule;clangTidyPerformanceModule;clangTidyReadabilityModule;clangTidyUtils;LLVM;\$<LINK_ONLY:clang-cpp>"
)
...
set_target_properties(clangdSupport PROPERTIES
  INTERFACE_LINK_LIBRARIES "-lpthread;LLVM"
)
...
set_target_properties(clangdRemoteIndex PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangDaemon;clangdSupport;LLVM"
)
